...
-b, --defaultBlockers strings   Comma separated list of problem types. If ANY of the provided problems is found, program exits with code 130. Default value is malware,ddos,broken_assembly (default [malware,ddos,broken_assembly])
